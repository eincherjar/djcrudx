    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        html = f"""
            <div class="relative" id="{field_id}_container" x-data="{{
                ...
                <div x-ref="menu" x-transition :class="open ? 'fixed z-[9999] bg-white border border-gray-300 rounded shadow-lg overflow-hidden block' : 'fixed z-[9999] bg-white border border-gray-300 rounded shadow-lg overflow-hidden hidden'"
